...
/*:: import type { JsonRpcError, JsonRpcAsyncResponse, JsonRpcSubscriptionResponse, ProviderInterface, ParamsType, ProviderResultCallback } from './types' */
...
class Ws extends JsonRpc /*:: implements ProviderInterface */ {
  ...
  send (method/*: string */, params/*: ParamsType */, callback/*: ProviderResultCallback */)/*: number */ {
  ...
  sendPromise (method/*: string */, params/*: ParamsType */)/*: Promise<string> */ {
  ...
  async subscribe (method/*: string */, params/*: ParamsType */, callback/*: ProviderResultCallback */)/*: Promise<string> */ {
